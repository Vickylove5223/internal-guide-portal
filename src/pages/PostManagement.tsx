...
const PostManagement = () => {
  ...
  const [posts, setPosts] = useState([
    ...
    { id: 3, title: 'Market Expansion Strategy Update', category: 'Business News', status: 'Published', author: 'Mike Wilson', createdAt: '2024-01-18T09:15:00Z' },
    ...
    { id: 6, title: 'Performance Review Process Changes', category: 'HR Updates', status: 'Published', author: 'Robert Taylor', createdAt: '2024-01-14T08:00:00Z' },
    { id: 7, title: 'Industry Leadership Recognition', category: 'Announcements', status: 'Draft', author: 'Amanda White', createdAt: '2024-01-11T12:45:00Z' },
    { id: 8, title: 'Wellness Program Initiative Launch', category: 'HR Updates', status: 'Published', author: 'Christopher Lee', createdAt: '2024-01-10T09:30:00Z' },
    { id: 9, title: 'Economic Outlook Report', category: 'Political News', status: 'Published', author: 'Patricia Martinez', createdAt: '2024-01-09T14:00:00Z' },
    { id: 10, title: 'New Hire Orientation Updates', category: 'HR Updates', status: 'Draft', author: 'Daniel Rodriguez', createdAt: '2024-01-08T11:15:00Z' },
    { id: 11, title: 'CEO Leadership Change Announcement', category: 'Announcements', status: 'Published', author: 'Kevin Clark', createdAt: '2024-01-06T13:45:00Z' },
    { id: 12, title: 'Professional Development Opportunities', category: 'HR Updates', status: 'Draft', author: 'Nancy Lewis', createdAt: '2024-01-05T10:00:00Z' },
    { id: 13, title: 'Customer Success Story Feature', category: 'Business News', status: 'Published', author: 'Steven Walker', createdAt: '2024-01-04T15:10:00Z' },
    { id: 14, title: 'Government Policy Impact Assessment', category: 'Political News', status: 'Published', author: 'Laura Hall', createdAt: '2024-01-03T08:30:00Z' },
    { id: 15, title: 'Year-End Achievement Awards', category: 'Announcements', status: 'Published', author: 'Maria Young', createdAt: '2024-01-01T17:30:00Z' },
    { id: 16, title: 'Digital Transformation Initiative', category: 'Business News', status: 'Published', author: 'Thomas Anderson', createdAt: '2024-01-22T09:00:00Z' },
    { id: 17, title: 'Health and Safety Protocol Update', category: 'HR Updates', status: 'Published', author: 'Jennifer Wilson', createdAt: '2024-01-21T14:30:00Z' },
    { id: 18, title: 'Regulatory Compliance Changes', category: 'Political News', status: 'Draft', author: 'Michael Johnson', createdAt: '2024-01-20T16:45:00Z' },
    { id: 19, title: 'Company Milestone Achievement', category: 'Announcements', status: 'Published', author: 'Sarah Davis', createdAt: '2024-01-19T11:20:00Z' },
    { id: 20, title: 'Strategic Partnership Announcement', category: 'Business News', status: 'Published', author: 'Robert Chen', createdAt: '2024-01-18T13:15:00Z' }
  ]);
